...
exports.create = async (req, res, next) => {
  try {
    ...
    if (req.file) data.profilePhoto = (await cloudinary.uploader.upload(req.file.path, { folder: "profiles" })).secure_url;
...
exports.update = async (req, res, next) => {
  try {
    ...
    if (req.file) updates.profilePhoto = (await cloudinary.uploader.upload(req.file.path, { folder: "profiles" })).secure_url;
